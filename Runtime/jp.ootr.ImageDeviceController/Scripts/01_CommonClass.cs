...
namespace jp.ootr.ImageDeviceController
{
    public class CommonClass : BaseClass
    {
        ...
        public readonly string[] SupportedFeatures = {"Format:Alpha8","Format:ARGB4444","Format:RGB24","Format:RGBA32","Format:ARGB32","Format:RGB565","Format:R16","Format:DXT1","Format:DXT5","Format:RGBA4444","Format:BGRA32","Format:RHalf","Format:RGHalf","Format:RGBAHalf","Format:RFloat","Format:RGFloat","Format:RGBAFloat","Format:YUY2","Format:RGB9e5Float","Format:BC6H","Format:BC7","Format:BC4","Format:BC5","Format:DXT1Crunched","Format:DXT5Crunched","Format:PVRTC_RGB2","Format:PVRTC_RGBA2","Format:PVRTC_RGB4","Format:PVRTC_RGBA4","Format:ETC_RGB4","Format:EAC_R","Format:EAC_R_SIGNED","Format:EAC_RG","Format:EAC_RG_SIGNED","Format:ETC2_RGB","Format:ETC2_RGBA1","Format:ETC2_RGBA8","Format:ASTC_4x4","Format:ASTC_5x5","Format:ASTC_6x6","Format:ASTC_8x8","Format:ASTC_10x10","Format:ASTC_12x12","Format:RG16","Format:R8","Format:ETC_RGB4Crunched","Format:ETC2_RGBA8Crunched","Format:ASTC_HDR_4x4","Format:ASTC_HDR_5x5","Format:ASTC_HDR_6x6","Format:ASTC_HDR_8x8","Format:ASTC_HDR_10x10","Format:ASTC_HDR_12x12","Format:RG32","Format:RGB48","Format:RGBA64" };
